...
export declare class IfcAPI {
   ...
   */
    ...
    */
     ...
     */
    FindSpacesMesh(modelID: number, types: Array<number>, spaceCallback: (geometry: IfcGeometry) => void, boundaryCallback: (space: number, buildingElement: string, loops: CrossSection, boundaryCondition: string) => void, msgCallback: (msg: string) => void): void;
    /**
